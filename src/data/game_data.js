...
export const novelsList = [
  {
    ...
    clueWall: {
      nodes: [
        { id: "attwn_rhyme", type: "clue", labelZH: "童谣预言", labelEN: "Nursery Rhyme", descZH: "挂在各个客房里的童谣，神秘地预言了岛上所有宾客的死亡顺序与手法。", descEN: "Nursery rhyme framed in rooms, predicting deaths of all guests.", unlockChapter: 1, x: 300, y: 60 },
        { id: "attwn_wargrave", type: "suspect", labelZH: "劳伦斯·瓦格雷夫", labelEN: "Lawrence Wargrave", descZH: "退休法官，被留声机控诉在1893年蓄意误导陪审团判处爱德华·塞顿绞刑。", descEN: "Retired judge, accused of misleading a jury to hang Edward Seton.", unlockChapter: 1, x: 480, y: 60 },
        { id: "attwn_vera", type: "suspect", labelZH: "维拉·克莱索恩", labelEN: "Vera Claythorne", descZH: "被控于1935年纵容年幼的西里尔·汉密尔顿溺水身亡以获取继承财产。", descEN: "Accused of letting young Cyril Hamilton drown to secure inheritance.", unlockChapter: 1, x: 640, y: 60 },
        { id: "attwn_armstrong", type: "suspect", labelZH: "爱德华·阿姆斯特朗", labelEN: "Edward Armstrong", descZH: "被控在醉酒状态下实施手术导致病人死亡。曾与法官结成秘密同盟。", descEN: "Accused of operating while drunk. Formed a secret alliance with Wargrave.", unlockChapter: 1, x: 580, y: 190 },
        { id: "attwn_marston_dead", type: "event", labelZH: "安东尼之死", labelEN: "Anthony Marston's Death", descZH: "饮用掺有氰化钾的酒窒息暴毙，正如童谣中所说的第一个小士兵噎死。", descEN: "Choked to death on cyanide-poisoned whiskey, matching the first soldier.", unlockChapter: 4, x: 320, y: 190 },
        { id: "attwn_rogers_mrs_dead", type: "event", labelZH: "罗杰斯太太之死", labelEN: "Mrs. Rogers' Death", descZH: "罗杰斯太太在睡梦中过量服用安眠药猝死，对应第二个小士兵睡死。", descEN: "Died in sleep of sedative overdose, matching the second soldier.", unlockChapter: 6, x: 450, y: 240 },
        { id: "attwn_wool_missing", type: "clue", labelZH: "丢失的毛线", labelEN: "Missing Grey Wool", descZH: "艾米莉·布伦特的灰色毛线球丢失，后证实与浴帘一起被凶手用来装扮死去的法官。", descEN: "Emily Brent's knitting wool goes missing, later used to dress Wargrave.", unlockChapter: 10, x: 300, y: 360 },
        { id: "attwn_rogers_mr_dead", type: "event", labelZH: "管家罗杰斯之死", labelEN: "Mr. Rogers' Death", descZH: "罗杰斯在后院劈柴时头部被斧头从后方劈开致死，对应第四个小士兵劈死。", descEN: "Head split by axe while chopping wood, matching the fourth soldier.", unlockChapter: 11, x: 440, y: 360 },
        { id: "attwn_brent_dead", type: "event", labelZH: "艾米莉之死", labelEN: "Emily Brent's Death", descZH: "被偷来的注射器注射氰化物死在客厅，窗外有大黄蜂飞过，对应第五个小士兵被蜇死。", descEN: "Injected with cyanide using stolen syringe, matching the fifth soldier.", unlockChapter: 12, x: 580, y: 360 },
        { id: "attwn_wargrave_dead", type: "event", labelZH: "瓦格雷夫之死", labelEN: "Wargrave's Death", descZH: "身穿红袍、戴着假发头部中枪死在椅子上，后证实为与医生的假死合谋。", descEN: "Found shot dressed in judicial robes, later revealed as faked death.", unlockChapter: 13, x: 740, y: 240 },
        { id: "attwn_bottle", type: "clue", labelZH: "漂流瓶手稿", labelEN: "Confession Manuscript", descZH: "真凶放入海中的自白信，披露了整场完美谋杀的作案细节与行凶初衷。", descEN: "Mastermind's confession bottle, detailing the plot and motives.", unlockChapter: 18, x: 820, y: 360 }
      ],
      links: [
